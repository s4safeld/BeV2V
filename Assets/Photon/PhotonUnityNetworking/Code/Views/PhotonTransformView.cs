        ...
        public void OnPhotonSerializeView(PhotonStream stream, PhotonMessageInfo info)
        {
            if (stream.IsWriting)
            {
                if (this.m_SynchronizePosition)
                {
                    ...
                    //Debug.Log(gameObject.name + " sending  position: " + transform.position);
                    stream.SendNext(transform.position);
                    //Debug.Log(gameObject.name + " sending direction: " + transform.position);
            ...
            else
            {
                ...
                if (this.m_SynchronizePosition)
                {
                    ...
                    //Debug.Log(gameObject.name + " receiving  position: " + this.m_NetworkPosition);
                    this.m_Direction = (Vector3)stream.ReceiveNext();
                    //Debug.Log(gameObject.name + " receiving direction: " + this.m_NetworkPosition);
